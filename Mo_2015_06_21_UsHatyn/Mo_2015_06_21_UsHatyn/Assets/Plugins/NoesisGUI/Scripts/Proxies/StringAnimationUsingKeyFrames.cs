...
public class StringAnimationUsingKeyFrames : AnimationTimeline {
  ...
  internal StringAnimationUsingKeyFrames(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.StringAnimationUsingKeyFrames_SWIGUpcast(cPtr), cMemoryOwn) {
  }
  ...
  public StringKeyFrameCollection KeyFrames {
    get {
      ...
      #endif
      return Noesis.Extend.GetProxy(cPtr, false) as StringKeyFrameCollection;
    }
  }

...
public class ResourceKeyType : BaseComponent {
  ...
  internal ResourceKeyType(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.ResourceKeyType_SWIGUpcast(cPtr), cMemoryOwn) {
  }
  ...
  public string GetStr() {
    string ret = NoesisGUI_PINVOKE.ResourceKeyType_GetStr(swigCPtr);

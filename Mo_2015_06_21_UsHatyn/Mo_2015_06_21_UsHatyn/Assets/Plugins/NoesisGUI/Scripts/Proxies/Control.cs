...
public class Control : FrameworkElement {
  ...
  internal Control(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.Control_SWIGUpcast(cPtr), cMemoryOwn) {
  }
  ...
  public ControlTemplate Template {
    ...
    get {
      ...
      if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
      #endif
      return Noesis.Extend.GetProxy(cPtr, false) as ControlTemplate;
    }
  }
  ...
  internal new static IntPtr Extend(System.Type type) {
    ...
    IntPtr nativeType = NoesisGUI_PINVOKE.Extend_Control(unityType);
    #if UNITY_EDITOR || NOESIS_API
    if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
    #endif
    return nativeType;

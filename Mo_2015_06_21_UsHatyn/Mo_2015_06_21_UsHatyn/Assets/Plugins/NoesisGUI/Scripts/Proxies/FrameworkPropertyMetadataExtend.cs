...
namespace Noesis
{
    ...
    public partial class FrameworkPropertyMetadata
    {
        ...
        private static IntPtr Noesis_CreateFrameworkPropertyMetadata_Color_(Noesis.Color defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            IntPtr result = Noesis_CreateFrameworkPropertyMetadata_Color(ref defaultValue, options,
                invokePropertyChangedCallback);
            #if UNITY_EDITOR || NOESIS_API
            Error.Check();
            #endif
        ...
        private static IntPtr Noesis_CreateFrameworkPropertyMetadata_Point_(Noesis.Point defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            IntPtr result = Noesis_CreateFrameworkPropertyMetadata_Point(ref defaultValue, options,
                invokePropertyChangedCallback);
            #if UNITY_EDITOR || NOESIS_API
            Error.Check();
            #endif
        ...
        private static IntPtr Noesis_CreateFrameworkPropertyMetadata_Rect_(Noesis.Rect defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            IntPtr result = Noesis_CreateFrameworkPropertyMetadata_Rect(ref defaultValue, options,
                invokePropertyChangedCallback);
            #if UNITY_EDITOR || NOESIS_API
            Error.Check();
            #endif
        ...
        private static IntPtr Noesis_CreateFrameworkPropertyMetadata_Size_(Noesis.Size defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            IntPtr result = Noesis_CreateFrameworkPropertyMetadata_Size(ref defaultValue, options,
                invokePropertyChangedCallback);
            #if UNITY_EDITOR || NOESIS_API
            Error.Check();
            #endif
        ...
        private static IntPtr Noesis_CreateFrameworkPropertyMetadata_Thickness_(Noesis.Thickness defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            IntPtr result = Noesis_CreateFrameworkPropertyMetadata_Thickness(ref defaultValue, options,
                invokePropertyChangedCallback);
            #if UNITY_EDITOR || NOESIS_API
            Error.Check();
            #endif
        ...
        private static IntPtr Noesis_CreateFrameworkPropertyMetadata_CornerRadius_(Noesis.CornerRadius defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            IntPtr result = Noesis_CreateFrameworkPropertyMetadata_CornerRadius(ref defaultValue, options,
                invokePropertyChangedCallback);
            #if UNITY_EDITOR || NOESIS_API
            Error.Check();
            #endif
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////
        delegate IntPtr CreateFrameworkPropertyMetadataDelegate_Color(ref Noesis.Color defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback);
        static CreateFrameworkPropertyMetadataDelegate_Color _CreateFrameworkPropertyMetadata_Color;
        private static IntPtr Noesis_CreateFrameworkPropertyMetadata_Color(ref Noesis.Color defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            return _CreateFrameworkPropertyMetadata_Color(ref defaultValue, options, invokePropertyChangedCallback);
        }

        ////////////////////////////////////////////////////////////////////////////////////////////////
        delegate IntPtr CreateFrameworkPropertyMetadataDelegate_Point(ref Noesis.Point defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback);
        static CreateFrameworkPropertyMetadataDelegate_Point _CreateFrameworkPropertyMetadata_Point;
        private static IntPtr Noesis_CreateFrameworkPropertyMetadata_Point(ref Noesis.Point defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            return _CreateFrameworkPropertyMetadata_Point(ref defaultValue, options, invokePropertyChangedCallback);
        }

        ////////////////////////////////////////////////////////////////////////////////////////////////
        delegate IntPtr CreateFrameworkPropertyMetadataDelegate_Rect(ref Noesis.Rect defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback);
        static CreateFrameworkPropertyMetadataDelegate_Rect _CreateFrameworkPropertyMetadata_Rect;
        private static IntPtr Noesis_CreateFrameworkPropertyMetadata_Rect(ref Noesis.Rect defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            return _CreateFrameworkPropertyMetadata_Rect(ref defaultValue, options, invokePropertyChangedCallback);
        }

        ////////////////////////////////////////////////////////////////////////////////////////////////
        delegate IntPtr CreateFrameworkPropertyMetadataDelegate_Size(ref Noesis.Size defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback);
        static CreateFrameworkPropertyMetadataDelegate_Size _CreateFrameworkPropertyMetadata_Size;
        private static IntPtr Noesis_CreateFrameworkPropertyMetadata_Size(ref Noesis.Size defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            return _CreateFrameworkPropertyMetadata_Size(ref defaultValue, options, invokePropertyChangedCallback);
        }

        ////////////////////////////////////////////////////////////////////////////////////////////////
        delegate IntPtr CreateFrameworkPropertyMetadataDelegate_Thickness(ref Noesis.Thickness defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback);
        static CreateFrameworkPropertyMetadataDelegate_Thickness _CreateFrameworkPropertyMetadata_Thickness;
        private static IntPtr Noesis_CreateFrameworkPropertyMetadata_Thickness(ref Noesis.Thickness defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            return _CreateFrameworkPropertyMetadata_Thickness(ref defaultValue, options, invokePropertyChangedCallback);
        }

        ////////////////////////////////////////////////////////////////////////////////////////////////
        delegate IntPtr CreateFrameworkPropertyMetadataDelegate_CornerRadius(ref Noesis.CornerRadius defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback);
        static CreateFrameworkPropertyMetadataDelegate_CornerRadius _CreateFrameworkPropertyMetadata_CornerRadius;
        private static IntPtr Noesis_CreateFrameworkPropertyMetadata_CornerRadius(ref Noesis.CornerRadius defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            return _CreateFrameworkPropertyMetadata_CornerRadius(ref defaultValue, options, invokePropertyChangedCallback);
        }
        ...
        private static extern IntPtr Noesis_CreateFrameworkPropertyMetadata_Color(
            ref Noesis.Color defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback);
        ...
        private static extern IntPtr Noesis_CreateFrameworkPropertyMetadata_Point(
            ref Noesis.Point defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback);
        ...
        private static extern IntPtr Noesis_CreateFrameworkPropertyMetadata_Rect(
            ref Noesis.Rect defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback);
        ...
        private static extern IntPtr Noesis_CreateFrameworkPropertyMetadata_Size(
            ref Noesis.Size defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback);
        ...
        private static extern IntPtr Noesis_CreateFrameworkPropertyMetadata_Thickness(
            ref Noesis.Thickness defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback);
        ...
        private static extern IntPtr Noesis_CreateFrameworkPropertyMetadata_CornerRadius(
            ref Noesis.CornerRadius defaultValue, int options,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback);

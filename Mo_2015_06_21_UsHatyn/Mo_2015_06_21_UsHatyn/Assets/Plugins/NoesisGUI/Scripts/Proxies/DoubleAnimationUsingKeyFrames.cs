...
public class DoubleAnimationUsingKeyFrames : AnimationTimeline {
  ...
  internal DoubleAnimationUsingKeyFrames(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.DoubleAnimationUsingKeyFrames_SWIGUpcast(cPtr), cMemoryOwn) {
  }
  ...
  public DoubleKeyFrameCollection KeyFrames {
    get {
      ...
      #endif
      return Noesis.Extend.GetProxy(cPtr, false) as DoubleKeyFrameCollection;
    }
  }

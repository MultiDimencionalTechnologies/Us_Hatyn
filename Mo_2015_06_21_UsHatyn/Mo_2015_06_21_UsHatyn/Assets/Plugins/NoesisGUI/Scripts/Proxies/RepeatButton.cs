...
public class RepeatButton : ButtonBase {
  ...
  internal RepeatButton(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.RepeatButton_SWIGUpcast(cPtr), cMemoryOwn) {
  }
  ...
  internal new static IntPtr Extend(System.Type type) {
    ...
    IntPtr nativeType = NoesisGUI_PINVOKE.Extend_RepeatButton(unityType);
    #if UNITY_EDITOR || NOESIS_API
    if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
    #endif
    return nativeType;

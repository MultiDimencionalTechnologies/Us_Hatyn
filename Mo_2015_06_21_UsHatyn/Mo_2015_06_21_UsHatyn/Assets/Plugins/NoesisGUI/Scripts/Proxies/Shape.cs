...
public class Shape : FrameworkElement {
  ...
  internal Shape(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.Shape_SWIGUpcast(cPtr), cMemoryOwn) {
  }
  ...
  public string StrokeDashArray {
    ...
    get {
      string ret = NoesisGUI_PINVOKE.Shape_StrokeDashArray_get(swigCPtr);
      #if UNITY_EDITOR || NOESIS_API
      if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
      #endif
      return ret;
  ...
  internal new static IntPtr Extend(System.Type type) {
    ...
    IntPtr nativeType = NoesisGUI_PINVOKE.Extend_Shape(unityType);
    #if UNITY_EDITOR || NOESIS_API
    if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
    #endif
    return nativeType;

...
public class ManipulationCompletedEventArgs : RoutedEventArgs {
  ...
  private ManipulationVelocities GetFinalVelocitiesHelper() {
    ManipulationVelocities ret = new ManipulationVelocities(NoesisGUI_PINVOKE.ManipulationCompletedEventArgs_GetFinalVelocitiesHelper(swigCPtr), true);
    #if UNITY_EDITOR || NOESIS_API
    if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
    #endif
    return ret;
  ...
  private ManipulationDelta GetTotalManipulationHelper() {
    ManipulationDelta ret = new ManipulationDelta(NoesisGUI_PINVOKE.ManipulationCompletedEventArgs_GetTotalManipulationHelper(swigCPtr), true);
    #if UNITY_EDITOR || NOESIS_API
    if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
    #endif
    return ret;

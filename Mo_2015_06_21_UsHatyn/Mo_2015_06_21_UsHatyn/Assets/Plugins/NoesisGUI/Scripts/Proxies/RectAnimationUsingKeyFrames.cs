...
public class RectAnimationUsingKeyFrames : AnimationTimeline {
  ...
  internal RectAnimationUsingKeyFrames(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.RectAnimationUsingKeyFrames_SWIGUpcast(cPtr), cMemoryOwn) {
  }
  ...
  public RectKeyFrameCollection KeyFrames {
    get {
      ...
      #endif
      return Noesis.Extend.GetProxy(cPtr, false) as RectKeyFrameCollection;
    }
  }

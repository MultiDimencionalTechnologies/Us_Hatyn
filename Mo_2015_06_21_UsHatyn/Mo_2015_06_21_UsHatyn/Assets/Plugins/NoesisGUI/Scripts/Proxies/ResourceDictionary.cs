...
public class ResourceDictionary : BaseDictionary {
  ...
  internal ResourceDictionary(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.ResourceDictionary_SWIGUpcast(cPtr), cMemoryOwn) {
  }
  ...
  public ResourceDictionaryCollection MergedDictionaries {
    get {
      ...
      if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
      #endif
      return Noesis.Extend.GetProxy(cPtr, false) as ResourceDictionaryCollection;
    }
  }
  ...
  public string Source {
    ...
    get {
      string ret = NoesisGUI_PINVOKE.ResourceDictionary_Source_get(swigCPtr);
      #if UNITY_EDITOR || NOESIS_API
      if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
      #endif
      return ret;

...
public class ControlTemplate : FrameworkTemplate {
  ...
  internal ControlTemplate(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.ControlTemplate_SWIGUpcast(cPtr), cMemoryOwn) {
  }
  ...
  public ResourceKeyType TargetType {
    set {
      NoesisGUI_PINVOKE.ControlTemplate_TargetType_set(swigCPtr, ResourceKeyType.getCPtr(value));

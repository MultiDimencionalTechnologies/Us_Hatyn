...
public class GridViewColumnHeader : ButtonBase {
  ...
  internal GridViewColumnHeader(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.GridViewColumnHeader_SWIGUpcast(cPtr), cMemoryOwn) {
  }
  ...
  public GridViewColumn Column {
    get {
      ...
      if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
      #endif
      return Noesis.Extend.GetProxy(cPtr, false) as GridViewColumn;
    }
  }

...
public class RoutedEvent : BaseComponent {
  ...
  internal RoutedEvent(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.RoutedEvent_SWIGUpcast(cPtr), cMemoryOwn) {
  }
  ...
  public string Name {
    get {
      string ret = NoesisGUI_PINVOKE.RoutedEvent_Name_get(swigCPtr);
      #if UNITY_EDITOR || NOESIS_API
      if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
      #endif
      return ret;

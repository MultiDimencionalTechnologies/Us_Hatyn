...
public class ManipulationDeltaEventArgs : RoutedEventArgs {
  ...
  private ManipulationDelta GetCumulativeManipulationHelper() {
    ManipulationDelta ret = new ManipulationDelta(NoesisGUI_PINVOKE.ManipulationDeltaEventArgs_GetCumulativeManipulationHelper(swigCPtr), true);
    #if UNITY_EDITOR || NOESIS_API
    if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
    #endif
    return ret;
  ...
  private ManipulationDelta GetDeltaManipulationHelper() {
    ManipulationDelta ret = new ManipulationDelta(NoesisGUI_PINVOKE.ManipulationDeltaEventArgs_GetDeltaManipulationHelper(swigCPtr), true);
    #if UNITY_EDITOR || NOESIS_API
    if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
    #endif
    return ret;
  ...
  private ManipulationVelocities GetVelocitiesHelper() {
    ManipulationVelocities ret = new ManipulationVelocities(NoesisGUI_PINVOKE.ManipulationDeltaEventArgs_GetVelocitiesHelper(swigCPtr), true);
    #if UNITY_EDITOR || NOESIS_API
    if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
    #endif
    return ret;

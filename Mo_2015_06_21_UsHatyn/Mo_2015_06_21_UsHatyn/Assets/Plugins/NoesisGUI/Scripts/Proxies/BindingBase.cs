...
public class BindingBase : BaseComponent {
  ...
  internal BindingBase(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.BindingBase_SWIGUpcast(cPtr), cMemoryOwn) {
  }
  ...
  public string StringFormat {
    ...
    get {
      string ret = NoesisGUI_PINVOKE.BindingBase_StringFormat_get(swigCPtr);
      #if UNITY_EDITOR || NOESIS_API
      if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
      #endif
      return ret;

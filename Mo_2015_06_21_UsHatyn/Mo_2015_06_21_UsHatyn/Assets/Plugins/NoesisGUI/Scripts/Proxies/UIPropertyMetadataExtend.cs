...
namespace Noesis
{
    ...
    public partial class UIPropertyMetadata
    {
        ...
        private static IntPtr Noesis_CreateUIPropertyMetadata_Color_(Noesis.Color defaultValue,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            IntPtr result = Noesis_CreateUIPropertyMetadata_Color(ref defaultValue,
                invokePropertyChangedCallback);
            #if UNITY_EDITOR || NOESIS_API
            Error.Check();
            #endif
        ...
        private static IntPtr Noesis_CreateUIPropertyMetadata_Point_(Noesis.Point defaultValue,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            IntPtr result = Noesis_CreateUIPropertyMetadata_Point(ref defaultValue,
                invokePropertyChangedCallback);
            #if UNITY_EDITOR || NOESIS_API
            Error.Check();
            #endif
        ...
        private static IntPtr Noesis_CreateUIPropertyMetadata_Rect_(Noesis.Rect defaultValue,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            IntPtr result = Noesis_CreateUIPropertyMetadata_Rect(ref defaultValue,
                invokePropertyChangedCallback);
            #if UNITY_EDITOR || NOESIS_API
            Error.Check();
            #endif
        ...
        private static IntPtr Noesis_CreateUIPropertyMetadata_Size_(Noesis.Size defaultValue,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            IntPtr result = Noesis_CreateUIPropertyMetadata_Size(ref defaultValue,
                invokePropertyChangedCallback);
            #if UNITY_EDITOR || NOESIS_API
            Error.Check();
            #endif
        ...
        private static IntPtr Noesis_CreateUIPropertyMetadata_Thickness_(Noesis.Thickness defaultValue,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            IntPtr result = Noesis_CreateUIPropertyMetadata_Thickness(ref defaultValue,
                invokePropertyChangedCallback);
            #if UNITY_EDITOR || NOESIS_API
            Error.Check();
            #endif
        ...
        private static IntPtr Noesis_CreateUIPropertyMetadata_CornerRadius_(Noesis.CornerRadius defaultValue,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            IntPtr result = Noesis_CreateUIPropertyMetadata_CornerRadius(ref defaultValue,
                invokePropertyChangedCallback);
            #if UNITY_EDITOR || NOESIS_API
            Error.Check();
            #endif
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////
        delegate IntPtr CreateUIPropertyMetadataDelegate_Color(ref Noesis.Color defaultValue,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback);
        static CreateUIPropertyMetadataDelegate_Color _CreateUIPropertyMetadata_Color;
        private static IntPtr Noesis_CreateUIPropertyMetadata_Color(ref Noesis.Color defaultValue,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            return _CreateUIPropertyMetadata_Color(ref defaultValue, invokePropertyChangedCallback);
        }

        ////////////////////////////////////////////////////////////////////////////////////////////////
        delegate IntPtr CreateUIPropertyMetadataDelegate_Point(ref Noesis.Point defaultValue,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback);
        static CreateUIPropertyMetadataDelegate_Point _CreateUIPropertyMetadata_Point;
        private static IntPtr Noesis_CreateUIPropertyMetadata_Point(ref Noesis.Point defaultValue,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            return _CreateUIPropertyMetadata_Point(ref defaultValue, invokePropertyChangedCallback);
        }

        ////////////////////////////////////////////////////////////////////////////////////////////////
        delegate IntPtr CreateUIPropertyMetadataDelegate_Rect(ref Noesis.Rect defaultValue,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback);
        static CreateUIPropertyMetadataDelegate_Rect _CreateUIPropertyMetadata_Rect;
        private static IntPtr Noesis_CreateUIPropertyMetadata_Rect(ref Noesis.Rect defaultValue,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            return _CreateUIPropertyMetadata_Rect(ref defaultValue, invokePropertyChangedCallback);
        }

        ////////////////////////////////////////////////////////////////////////////////////////////////
        delegate IntPtr CreateUIPropertyMetadataDelegate_Size(ref Noesis.Size defaultValue,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback);
        static CreateUIPropertyMetadataDelegate_Size _CreateUIPropertyMetadata_Size;
        private static IntPtr Noesis_CreateUIPropertyMetadata_Size(ref Noesis.Size defaultValue,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            return _CreateUIPropertyMetadata_Size(ref defaultValue, invokePropertyChangedCallback);
        }

        ////////////////////////////////////////////////////////////////////////////////////////////////
        delegate IntPtr CreateUIPropertyMetadataDelegate_Thickness(ref Noesis.Thickness defaultValue,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback);
        static CreateUIPropertyMetadataDelegate_Thickness _CreateUIPropertyMetadata_Thickness;
        private static IntPtr Noesis_CreateUIPropertyMetadata_Thickness(ref Noesis.Thickness defaultValue,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            return _CreateUIPropertyMetadata_Thickness(ref defaultValue, invokePropertyChangedCallback);
        }

        ////////////////////////////////////////////////////////////////////////////////////////////////
        delegate IntPtr CreateUIPropertyMetadataDelegate_CornerRadius(ref Noesis.CornerRadius defaultValue,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback);
        static CreateUIPropertyMetadataDelegate_CornerRadius _CreateUIPropertyMetadata_CornerRadius;
        private static IntPtr Noesis_CreateUIPropertyMetadata_CornerRadius(ref Noesis.CornerRadius defaultValue,
            DelegateInvokePropertyChangedCallback invokePropertyChangedCallback)
        {
            return _CreateUIPropertyMetadata_CornerRadius(ref defaultValue, invokePropertyChangedCallback);
        }

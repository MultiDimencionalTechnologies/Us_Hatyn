...
public class Slider : RangeBase {
  ...
  internal Slider(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.Slider_SWIGUpcast(cPtr), cMemoryOwn) {
  }
  ...
  public string Ticks {
    ...
    get {
      string ret = NoesisGUI_PINVOKE.Slider_Ticks_get(swigCPtr);
      #if UNITY_EDITOR || NOESIS_API
      if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
      #endif
      return ret;
  ...
  internal new static IntPtr Extend(System.Type type) {
    ...
    IntPtr nativeType = NoesisGUI_PINVOKE.Extend_Slider(unityType);
    #if UNITY_EDITOR || NOESIS_API
    if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
    #endif
    return nativeType;

...
internal class ExtendConverter : BaseComponent {
  ...
  internal ExtendConverter(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.ExtendConverter_SWIGUpcast(cPtr), cMemoryOwn) {
  }
  ...
  internal new static IntPtr Extend(System.Type type) {
    ...
    IntPtr nativeType = NoesisGUI_PINVOKE.Extend_ExtendConverter(unityType);

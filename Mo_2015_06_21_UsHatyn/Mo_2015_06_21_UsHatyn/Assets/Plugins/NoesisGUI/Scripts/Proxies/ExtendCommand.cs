...
internal class ExtendCommand : BaseComponent {
  ...
  internal ExtendCommand(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.ExtendCommand_SWIGUpcast(cPtr), cMemoryOwn) {
  }
  ...
  internal new static IntPtr Extend(System.Type type) {
    ...
    IntPtr nativeType = NoesisGUI_PINVOKE.Extend_ExtendCommand(unityType);

...
public class TickBar : FrameworkElement {
  ...
  internal TickBar(IntPtr cPtr, bool cMemoryOwn) : base(NoesisGUI_PINVOKE.TickBar_SWIGUpcast(cPtr), cMemoryOwn) {
  }
  ...
  public string Ticks {
    ...
    get {
      string ret = NoesisGUI_PINVOKE.TickBar_Ticks_get(swigCPtr);
      #if UNITY_EDITOR || NOESIS_API
      if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
      #endif
      return ret;
  ...
  internal new static IntPtr Extend(System.Type type) {
    ...
    IntPtr nativeType = NoesisGUI_PINVOKE.Extend_TickBar(unityType);
    #if UNITY_EDITOR || NOESIS_API
    if (NoesisGUI_PINVOKE.SWIGPendingException.Pending) throw NoesisGUI_PINVOKE.SWIGPendingException.Retrieve();
    #endif
    return nativeType;
